...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Developer Tools}{: Git, Docker, Kubernetes, Nomad, Terraform, Ansible, GitHub Actions, Datadog, VS Code} \\
     \textbf{Libraries}{: Boto3, Pandas, Playwright, Selenium, BeautifulSoup, FastAPI, Requests, Pytest, Numpy} \\
     \textbf{Other}{: Linux, Bash, SQL, NoSQL, REST API, CI/CD, Agile, Scrum, Kanban, Trello, Jira, Confluence} \\
